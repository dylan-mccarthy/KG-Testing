...
const personalFacts: TestScenario = {
  ...
  turns: [
    ...
    { userMessage: "Where does Alex's wife work?", expectedKeywords: ["children's hospital", 'seattle', 'nurse'], factTag: 'spouse_job' },
...
const entityRelations: TestScenario = {
  ...
  turns: [
    ...
    { userMessage: "How long has the CEO been at Acme Corp?", expectedKeywords: ['8', 'years'], factTag: 'ceo_tenure' },
...
const temporalSequence: TestScenario = {
  ...
  turns: [
    ...
    { userMessage: "How quickly did the user base grow after launch?", expectedKeywords: ['340%', '45 days'], factTag: 'user_growth' },
    { userMessage: "What was the uptime percentage after launch?", expectedKeywords: ['99.7%', '99.7'], factTag: 'uptime' },
